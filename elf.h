...
#define R_X86_64_GOTPCREL64 28   /* 64 bit signed pc relative
                        offset to GOT entry */
#define R_X86_64_GOTPC64  29     /* 64 bit signed pc relative
                        offset to GOT */
#define R_X86_64_GOTPLT64 30     /* Obsolete. The same as GOT64. */
#define R_X86_64_PLTOFF64 31     /* 64 bit GOT relative offset
                        to PLT entry */
#define R_X86_64_SIZE32   32     /* 32-bit symbol size */
#define R_X86_64_SIZE64   33     /* 64-bit symbol size */
#define R_X86_64_GOTPC32_TLSDESC 34
                    /* 32 bit signed pc relative
                    offset to TLS descriptor
                    in the GOT.  */
#define R_X86_64_TLSDESC_CALL 35 /* Relaxable call through TLS
                    descriptor.  */
#define R_X86_64_TLSDESC 36      /* 2x64-bit TLS descriptor.  */
#define R_X86_64_IRELATIVE 37    /* Adjust indirectly by program base */
#define R_X86_64_RELATIVE64 38   /* 64bit adjust by program base */
#define R_X86_64_PC32_BND 39     /* PC relative 32 bit
                    signed with BND prefix  */
#define R_X86_64_PLT32_BND 40    /* 32 bit PLT address with
                    BND prefix */
